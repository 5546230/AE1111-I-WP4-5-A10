...
def main():
    ...
    ribs_list = np.array([0.47, 0.94, 1.78, 2.06, 2.61, 3.28, 3.68, 4.71, 5.44, 6.14, 6.8, 7.43, 8.03, 8.59, 9.13, 9.64, 10.12, 11,12])
    #np.array([0.35, 0.71, 2.57, 4.25, 5.76, 7.11, 7.72, 8.30, 8.85, 9.37, 9.87, 10.34, 10.79, 11.22, 11.62])
    #np.array([0.47, 0.94, 1.35, 1.78, 2.06, 2.36, 2.61, 2.86, 3.28, 3.68, 4.2, 4.71, 5.44, 6.14, 6.8, 7.43, 8.03, 8.59, 9.13, 9.64, 10.12, 11,12])
